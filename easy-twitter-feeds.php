    ...
    class EASY_TF_EASY_TWITTER_FEEDS
    {
        ...
        public function adminEnqueueScripts($hook)
        {
            ...
            if ( $post_type =="easy-twitter-feeds") {
                wp_enqueue_style('mcbAdmin',EASY_TF_DIR_URL . 'assets/css/admin.css', [], EASY_TF_VERSION);
                wp_enqueue_script('mcbAdmin',EASY_TF_DIR_URL . 'assets/js/admin.js', ['wp-i18n'], EASY_TF_VERSION, true);
            }
        }
    }
